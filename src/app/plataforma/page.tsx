  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="grow">
        ...
        <section
          id="home"
          className="flex flex-col md:flex-row items-center justify-center min-h-[70vh] bg-gradient-to-br from-blue-50 via-white to-blue-50 p-8 md:p-12 lg:p-16 relative overflow-hidden"
        >
          {/* Content */}
